...
//Function to determine the partition size where the cost of insertion sort is lower than that of quicksort, O(n²log(n))
...
//function that prints quicksort performance statistics on a vector with a defined number of breaks, O(1)
...
//function that prints insertion sort performance statistics on a vector with a defined number of breaks, O(1)
...
//function that registers quicksort/insertion sort performances statistics on a vector with a defined number of breaks, O(1)
