...
class UniversalSorter{
    ...
    void universal_sorter(int *vector, int vector_size, int partition_threshold, int breaks_threshold);
    ...
    void register_partition_statistics(PartitionStatistics *statistics, int num_partitions, int partition_size, int statistics_size);
    ...
    void register_break_statistics(BreaksStatistics *statistics_quick_sort, int num_breaks, int quant_num_breaks_tested, int current_index);
